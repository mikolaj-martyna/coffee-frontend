...
export default function AdminOrders() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            let res = await fetch("https://spring.skni.umcs.pl/api/order/get/all", {
                method: "GET",
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            await fetch(`https://spring.skni.umcs.pl/api/order/delete/${id}`, {
                method: "DELETE",
                headers: {
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
                }
    ...
    const handleEditSubmit = async (event) => {
        ...
        try {
            await fetch(`https://spring.skni.umcs.pl/api/order/update`, {
                method: "PUT",
                headers: {
                    'Authorization': 'Bearer ' + localStorage.getItem('token'),
